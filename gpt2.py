...
class GPT2Model(GPT2PreTrainedModel):
    ...
    def execute(
        ...
        t2=time.time()
        # print('attn time: ',t2-t1)
        hidden_states = self.ln_f(hidden_states)
        t3 = time.time()
        # print('trans ln: ',t3-t2)
...
class GPT2LMHeadModel(GPT2PreTrainedModel):
    ...
    def execute(
        ...
        t2 = time.time()
        # print('transformer time: ',t2 - begin)
